...
summary: "A mixed electroacoustic piece for saxophone, cymbal and live electronics, built around the sonic character of a blacksmith's forge and performed from a graphic score in three parts."
featured: true
status: published
order: 3
cover: ./score.png
coverAlt: "The graphic score: three columns headed Pray, Forge and Transfiguration, each carrying a strip of notation for saxophone, a band of forge imagery for cymbal and an envelope plot for electronics, above a legend of the three effect chains."
credits:
  - role: "Saxophone"
    who: "Berke Baramuk"
  - role: "Electronics & cymbal"
    who: "Kerem Eren Altaylar"
links: {}
---
...
![Stage plan and technical description: saxophone with a dynamic mic and cymbal with a condenser angled toward the audience, both routed to a laptop and a Novation controller, with a speaker at each outer edge of the stage.](./setup.png)
